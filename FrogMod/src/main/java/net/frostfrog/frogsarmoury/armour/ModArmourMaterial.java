package net.frostfrog.frogsarmoury.armour;
...
{
    FARAAM(FrogsArmoury.MOD_ID + ":faraam", 15, new int[] {2, 5, 6, 2}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 2.0f, ()-> {return Ingredient.fromItems(Items.IRON_INGOT);});
